...
{"0": {
    ...
    "doc": "CORETIMER periodic interrupt",
    "title": "Running the Application",
    "content": ". | Build and program the application project using its IDE | LED Blinks continuosly | . The following table provides the details of LED: . | Board | LED Name | . | Curiosity PIC32MX470 Development Board | LED1 | . | PIC32 Ethernet Starter Kit | LED1 | . | PIC32MX274 XLP Starter Kit | LED1(RED) | . |   |   | . ",
    ...
    "doc": "GPIO interrupt",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github, go to the main page of this repository and then click Clone button to clone this repository or download as zip file. This content can also be downloaded using content manager by following these instructions. Path of the application within the repository is apps/gpio/gpio_led_on_off_interrupt/firmware . To build the application, refer to the following table and open the project using its IDE. | Project Name | Description | . | pic32mx470_curiosity.X | MPLABX project for Curiosity PIC32MX470 Development Board | . | pic32mx_eth_sk2.X | MPLABX project for PIC32 Ethernet Starter Kit | . |   |   | . ",
    ...
    "doc": "GPIO interrupt",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mx470_curiosity.X | Curiosity PIC32MX470 Development Board | . | pic32mx_eth_sk2.X | PIC32 Ethernet Starter Kit | . |   |   | . Setting up Curiosity PIC32MX470 Development Board . | Connect mini USB cable to the ‘Debug USB’ connector(J3) on the board to the computer | . Setting up PIC32 Ethernet Starter Kit . | Connect micro USB cable to the ‘Debug USB’ connector(J7) on the board to the computer | . ",
    ...
    "doc": "GPIO interrupt",
    "title": "Running the Application",
    "content": ". | Build and program the application project using its IDE | The LED is turned ON when the switch is pressed and turned OFF when the switch is released | . The following table provides the switch and the LED name: . | Kit name | Switch Name | LED Name | . | Curiosity PIC32MX470 Development Board | S1 | LED1 | . | PIC32 Ethernet Starter Kit | SW1 | LED1 | . |   |   |   | . ",
    ...
    "doc": "NVM flash read write",
    "title": "Running the Application",
    "content": ". | Build and program the application project using its respective IDE | LED indicates the success or failure: . | LED is turned ON when the value read from the Flash matched with the written value | . | . Following table provides the LED name: . | Board | LED Name | . | Curiosity PIC32MX470 Development Board | LED1 | . | PIC32 Ethernet Starter Kit | LED1 | . | PIC32MX274 XLP Starter Kit | LED1 (RED) | . |   |   | . ",
    ...
    "doc": "OCMP compare mode",
    "title": "Running the Application",
    "content": ". | Build and program the application project using its IDE | Observe active low, active high and toggle output on the oscilloscope . | Refer the following table for pin details: . | OCMP output | Curiosity PIC32MX470 Development Board pins | PIC32 Ethernet Starter Kit pins | PIC32MX274 XLP Starter Kit pins | . | OC1 output | RPD0 “Pin 6 of J14” | RD0 “LED1” | RC7 “Pin 5 of J2” | . | OC2 output | RPG9 “Pin 10 of J14” | RD2 “LED2” | RA8 “Pin 13 of J2” | . | OC3 output | RPB9 “Pin 3 of J14” | RD2 “LED3” | RB14 “Pin 12 of J2” | . |   |   |   |   | . | . ",
    ...
    "doc": "TMR periodic interrupt",
    "title": "Running the Application",
    "content": ". | Build and program the application project using its IDE | On successful execution, LED starts blinking | . Following table provides the LED names: . | Board | LED Name | . | Curiosity PIC32MX470 Development Board | LED1 | . | PIC32MX1/2/5 Starter Kit | LED1 | . | MPLAB Starter Kit for PIC32MX1XX/2XX | LED(D1) | . | PIC32 Ethernet Starter Kit | LED1 | . | PIC32 USB Starter Kit III | LED1 | . | PIC32MX274 XLP Starter Kit | LED1(RED) | . |   |   | . ",
    ...
    "doc": "WDT timeout",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mx470_curiosity.X | Curiosity PIC32MX470 Development Board | . |   |   | . Setting up Curiosity PIC32MX470 Development Board . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
...
var repo_name = "csp_apps_pic32mx";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Harmony 3 peripheral library application examples for PIC32MX family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/csp_apps_pic32mx/assets/css/just-the-docs-' + theme + '.css');
}

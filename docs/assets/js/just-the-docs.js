...
{"0": {
    ...
    "doc": "RCON reset handler",
    "title": "Running the Application",
    "content": ". | Open the Terminal application (Ex.:Tera term) on the computer | Connect to the “USB to UART” COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Build and Program the application project using its IDE | Following message is output on console: . | Watch timer is fed periodically using Core Timer to prevent the WDT reset and the LED is toggled . | Following table provides the switch and the LED name: | . | Board | LED Name | Switch Name | . | Curiosity PIC32MX470 Development Board | LED1 | S1 | . | Press the switch to put the system in deadlock | LED should stop blinking and the console should print the following message . | The WDT will reset the device in four seconds and the demonstration should restart | . ",
    ...
    "doc": "SPI blocking",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mx470_curiosity.X | Curiosity PIC32MX470 Development Board | . | pic32mx_xlp_sk.X | PIC32MX274 XLP Starter Kit | . |   |   | . Setting up Curiosity PIC32MX470 Development Board . | Use a jumper wire to short pin MOSI and pin MISO of the J10 connector | Connect mini USB cable to the ‘Debug USB’ connector(J3) on the board to the computer | Note: Ensure that the series resistors on the mikroBUS headers are of value 0 Ohms | . Setting up PIC32MX274 XLP Starter Kit . | Use a jumper wire to short pin MOSI and pin MISO of the J5 connector | Connect micro USB cable to the ‘Debug USB’ connector(J9) on the board to the computer | . ",
    ...
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MX family  v3.4.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | Curiosity PIC32MX470 Development Board | 27 | . | PIC32MX274 XLP Starter Kit | 21 | . | PIC32MX1/2/5 Starter Kit | 3 | . | PIC32 Ethernet Starter Kit | 9 | . | PIC32MX Starter Kit | 8 | . | MPLAB Starter Kit for PIC32MX1XX/2XX | 1 | . | PIC32 USB Starter Kit III | 1 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.05 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.3.0 | . | MPLAB® XC32 C/C++ Compiler v4.21 | . ",
    "url": "http://localhost:4000/csp_apps_pic32mx/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mx-family--v340",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mx-family--v340"
  },"189": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MX family  v3.3.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | Curiosity PIC32MX470 Development Board | 27 | . | PIC32MX274 XLP Starter Kit | 21 | . | PIC32MX1/2/5 Starter Kit | 3 | . | PIC32 Ethernet Starter Kit | 9 | . | PIC32MX Starter Kit | 8 | . | MPLAB Starter Kit for PIC32MX1XX/2XX | 1 | . | PIC32 USB Starter Kit III | 1 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v6.00 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.1.9 | . | MPLAB® XC32 C/C++ Compiler v4.10 | . ",
    "url": "http://localhost:4000/csp_apps_pic32mx/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mx-family--v330",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mx-family--v330"
  },"190": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MX family  v3.2.0",
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | Curiosity PIC32MX470 Development Board | 27 | . | PIC32MX274 XLP Starter Kit | 21 | . | PIC32MX1/2/5 Starter Kit | 3 | . | PIC32 Ethernet Starter Kit | 9 | . | PIC32MX Starter Kit | 8 | . | MPLAB Starter Kit for PIC32MX1XX/2XX | 1 | . | PIC32 USB Starter Kit III | 1 | . New Features . | None | . Known Issues . | None | . Development Tools . | MPLAB® X IDE v5.50 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.8.0 | . | MPLAB® XC32 C/C++ Compiler v3.01 | . ",
    "url": "http://localhost:4000/csp_apps_pic32mx/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mx-family--v320",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mx-family--v320"
  },"191": {
    "doc": "Release notes",
    "title": "Harmony 3 peripheral library application examples for PIC32MX family  v3.1.1",
    "content": "New Features . | Same as v3.1.0 | . Bug fixes . | Updated tmr_timer_mode demo application | . Known Issues . | Same as v3.1.0 | . Development Tools . | Same as v3.1.0 | . ",
    "url": "http://localhost:4000/csp_apps_pic32mx/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mx-family--v311",
    "relUrl": "/release_notes.html#harmony-3-peripheral-library-application-examples-for-pic32mx-family--v311"
  },"192": {
    "doc": "Release notes",
    ...
    "content": "Development kit and demo application support . Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLAB X applications | . | PIC32MX274 XLP Starter Kit | 20 | . | MPLAB Starter Kit for PIC32MX1XX/2XX | 1 | . | Curiosity PIC32MX470 Development Board | 27 | . | PIC32 Ethernet Starter Kit | 9 | . | PIC32 USB Starter Kit III | 1 | . | PIC32MX1/2/5 Starter Kit | 3 | . New Features . New features added in this release are as follows: . | Applications migrated from csp repository to this new application repository for PIC32MX development boards | . Known Issues . The current known issues are as follows: . | None | . Development Tools . | MPLAB® X IDE v5.40 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.6.0 | . | MPLAB® XC32 C/C++ Compiler v2.41 | . ",
